---
title: "RNAseq using Deseq2 and Functional enrichment Analysis"
...
When considering batch effects in group design, it takes into account the mean differences across batch, not necessarily the variance differences. ComBat-Seq is designed to address both mean and variance batch effects.
In theory, no, you do not need to include batch as a covariate any more. However, you can always try both and evaluate the results.
